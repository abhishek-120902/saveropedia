...
import com.abhishek.saveropedia.databinding.ActivityRoposoBinding;
    ...
    class callGetRoposoData extends AsyncTask<String, Void, Document> {
        ...
        protected void onPostExecute(Document result) {
            ...
            try {
                ...
                if (!VideoUrl.equals("")) {
                    try {
                        Utils.startDownload(VideoUrl, Utils.RootDirectoryRoposo, activity, "roposo_"+System.currentTimeMillis() + ".mp4");
                        VideoUrl = "";
                        binding.etText.setText("");
