...
import com.abhishek.saveropedia.databinding.ActivitySnackvideoBinding;
    ...
    private DisposableObserver<JsonObject> observer = new DisposableObserver<JsonObject>() {
        ...
        public void onNext(JsonObject jsonObject) {
            ...
            try {
                ...
                Utils.startDownload(VideoUrl, Utils.RootDirectorySnackVideo, activity, "snackvideo_"+System.currentTimeMillis() + ".mp4");
                VideoUrl = "";
                binding.etText.setText("");
