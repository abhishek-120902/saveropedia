...
import com.abhishek.saveropedia.databinding.ActivityLikeeBinding;
    ...
    class callGetLikeeData extends AsyncTask<String, Void, Document> {
        ...
        protected void onPostExecute(Document result) {
            ...
            try {
                ...
                if (!VideoUrl.equals("")) {
                    try {
                        Utils.startDownload(VideoUrl, Utils.RootDirectoryLikee, activity, getFilenameFromURL(VideoUrl));
                        progressDialog.show();
