...
import com.abhishek.saveropedia.databinding.ActivitySharechatBinding;
    ...
    class callGetShareChatData extends AsyncTask<String, Void, Document> {
        ...
        protected void onPostExecute(Document result) {
            ...
            try {
                ...
                if (!VideoUrl.equals("")) {
                    try {
                        Utils.startDownload(VideoUrl, Utils.RootDirectoryShareChat, activity, "sharechat_"+System.currentTimeMillis() + ".mp4");
                        VideoUrl = "";
                        binding.etText.setText("");
